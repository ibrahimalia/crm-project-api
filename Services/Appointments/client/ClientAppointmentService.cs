...
{
    public class ClientAppointmentService : BaseService, IClientAppointmentService
    {
        private readonly IWebHostEnvironment _env;

        public ClientAppointmentService(MetaITechDbContext dbcontext, IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor)
