...
namespace Meta.IntroApp.Migrations
{
    ...
    [Migration("20210619060713_AddFK-InvolvementLevelToContacts")]
    partial class AddFKInvolvementLevelToContacts
    {
            ...
            modelBuilder.Entity("Meta.IntroApp.DbModels.MobRequest", b =>
                {
                    ...
                    b.Property<int?>("MobServiceServicesId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MobServiceServicesId");
            ...
            modelBuilder.Entity("Meta.IntroApp.DbModels.MobRequest", b =>
                {
                    ...
                    b.HasOne("Meta.IntroApp.MobService", null)
                        .WithMany("MobRequest")
                        .HasForeignKey("MobServiceServicesId");
