...
namespace Meta.IntroApp.Migrations
{
    ...
    [Migration("20210627132551_AddRelationBetweenTaskOwnerAndTaskFollower")]
    partial class AddRelationBetweenTaskOwnerAndTaskFollower
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Meta.IntroApp.DbModels.PRJAddressType", b =>
                {
                    b.HasOne("Meta.IntroApp.DbModels.PRJContacts", "Create")
                        .WithMany()
                    ...
                    b.HasOne("Meta.IntroApp.DbModels.PRJContacts", "Update")
                        .WithMany()
            ...
            modelBuilder.Entity("Meta.IntroApp.DbModels.PRJAttachements", b =>
                {
                    b.HasOne("Meta.IntroApp.DbModels.PRJContacts", "CreatedAccount")
                        .WithMany()
                        .HasForeignKey("CreatedBy");
                    ...
                    b.HasOne("Meta.IntroApp.DbModels.PRJContacts", "Updated")
                        .WithMany()
                        .HasForeignKey("UpdatedBy");
            ...
            modelBuilder.Entity("Meta.IntroApp.DbModels.PRJContacts", b =>
                {
                    b.HasOne("Meta.IntroApp.Account", "CreatedAccount")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Meta.IntroApp.DbModels.PRJJobPosition", null)
                        .WithMany("Contacts")
                        .HasForeignKey("PRJJobPositionId");

                    b.HasOne("Meta.IntroApp.Account", "Updated")
                        .WithMany()
                        .HasForeignKey("UpdatedBy");
            ...
            modelBuilder.Entity("Meta.IntroApp.DbModels.PRJInvolvementLevel", b =>
                {
                    b.HasOne("Meta.IntroApp.DbModels.PRJContacts", "HomeTeam")
                        .WithMany()
                        .HasForeignKey("CreatedBy");
                    ...
                    b.HasOne("Meta.IntroApp.DbModels.PRJContacts", "AwayTeam")
                        .WithMany()
                        .HasForeignKey("UpdatedBy");
